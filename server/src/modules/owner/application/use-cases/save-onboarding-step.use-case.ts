...
export class SaveOnboardingStepUseCase implements ISaveOnboardingStepUseCase {
  ...
  async execute(
    ...
    const updatedOwner = new Owner({
      ...
      street1: details.street1 !== undefined ? details.street1 : owner.street1,
      street2: details.street2 !== undefined ? details.street2 : owner.street2,
      city: details.city !== undefined ? details.city : owner.city,
      state: details.state !== undefined ? details.state : owner.state,
      postalCode: details.postalCode !== undefined ? details.postalCode : owner.postalCode,
      country: details.country !== undefined ? details.country : owner.country,
    ...
    const mergedDetails: IOwnerOnboardingDetails = {
      ...
      street1: savedOwner.street1,
      street2: savedOwner.street2,
      city: savedOwner.city,
      state: savedOwner.state,
