      ...
      {isOpen && (
        ...
        >
          ...
          <div className="relative p-1">
            ...
            {isSearching && <Loading size="sm" className="absolute right-3 top-3" />}
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 truncate">
                        <MapPin
                          className={`h-3.5 w-3.5 shrink-0 ${isSelected ? "text-primary" : "text-muted-foreground group-hover:text-foreground"}`}
                        />
