  ...
  if (isFetchingStatus) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        <Loading size="lg" />
        <p className="text-sm text-slate-400 font-medium animate-pulse">Loading your progress…</p>
      </div>
    )
  }
            ...
            <div className="mb-6 p-4 border border-red-500/20 bg-red-500/5 rounded-2xl flex gap-3 text-left">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
                  Your previous onboarding application was rejected by the administrator for the
                  following reason:
                </p>
