import { Users, UserCheck, ShieldCheck, UserX, AlertCircle, CheckCircle2, FileText } from "lucide-react";
  ...
  if (isOwnerApproval) {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="flex items-center justify-between p-5 rounded-2xl border border-border/80 bg-card/65 backdrop-blur-sm">
          <div className="space-y-1 text-left">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Approved Owners</span>
        ...
        <div className="flex items-center justify-between p-5 rounded-2xl border border-border/80 bg-card/65 backdrop-blur-sm">
          <div className="space-y-1 text-left">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Total Owners</span>
