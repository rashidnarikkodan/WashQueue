...
export default function SidebarWidgetsSection() {
  ...
  return (
    <div className="lg:col-span-4 space-y-6 animate-in slide-in-from-right duration-500 text-left">
      ...
      <div className="bg-card border border-slate-800/80 rounded-3xl p-6 shadow-xl space-y-6">
        <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest">
          Queue Intelligence
        </h3>
        
        <div className="space-y-4">
          <div className="flex items-center gap-4 bg-card p-3.5 rounded-2xl border border-slate-800/30">
      ...
      <div className="bg-card border border-slate-800/80 rounded-3xl p-6 shadow-xl space-y-4 relative overflow-hidden">
