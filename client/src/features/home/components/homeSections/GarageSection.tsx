          ...
          return (
            ...
            >
              ...
              <div className="h-56 relative overflow-hidden">
                ...
                <span
                  className={`absolute top-4 left-4 flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider backdrop-blur-md shadow-md ${
                    isOverdue
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${isOverdue ? "bg-rose-400" : "bg-emerald-400"}`}
                  />
                  {vehicle.statusText}
                </span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      {vehicle.typeBadges.map((badge, bIdx) => (
                        <span
                          key={bIdx}
                          className="bg-muted/80 text-muted-foreground text-[9px] font-black px-2 py-1 rounded-md tracking-wider"
                        >
                          {badge}
                        </span>
                      ))}
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-2 border-t border-border pt-4">
                    ...
                    <div>
                      ...
                      <span
                        className={`text-sm font-bold ${isOverdue ? "text-rose-400" : "text-emerald-400"}`}
                      >
                        {vehicle.nextWash}
                      </span>
                    </div>
